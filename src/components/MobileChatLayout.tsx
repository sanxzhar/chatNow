    ...
    <div className='fixed bg-zinc-50 border-b border-zinc-200 top-0 inset-x-0 py-2 px-4'>
      <div className='w-full flex justify-between items-center'>
        <Link
          ...
          <Icons.Logo className='h-6 w-auto text-[#FF9600]' />
        </Link>
                      ...
                      <div className='px-4 sm:px-6'>
                        <div className='flex items-start justify-between'>
                          ...
                          <div className='ml-3 flex h-7 items-center'>
                            <button
                              type='button'
                              className='rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FF9600] focus:ring-offset-2'
                                ...
                                {sidebarOptions.map((option) => {
                                  ...
                                  return (
                                    <li key={option.name}>
                                      <Link
                                        href={option.href}
                                        className='text-gray-700 hover:text-[#FF9600] hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold'>
